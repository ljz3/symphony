    ...
    [
      ...
      test_coverage: [
        ...
        ignore_modules: [
          ...
          SymphonyElixir.Backend.CodexAppServer,
          SymphonyElixir.Backend.KimiACP,
          ...
          SymphonyElixir.CLI,
          SymphonyElixir.CLI.StartupError,
          ...
          SymphonyElixir.Repo,
          SymphonyElixir.Repo.StartupError,
          ...
          SymphonyElixirWeb.NotFoundController,
