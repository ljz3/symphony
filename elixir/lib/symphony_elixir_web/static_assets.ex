defmodule SymphonyElixirWeb.StaticAssets do
  ...
  @board_css_path Path.expand("../../priv/static/board.css", __DIR__)
  ...
  @external_resource @board_css_path
  ...
  @board_css File.read!(@board_css_path)
  @board_css_digest :crypto.hash(:sha256, @board_css)
  ...
  @spec board_css_url() :: String.t()
  def board_css_url, do: "/board.css?v=#{@board_css_digest}"
