defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          codex_allowed_model_efforts: %{"gpt-5.5" => ["xhigh"]},
    ...
    codex_allowed_model_efforts = Keyword.get(config, :codex_allowed_model_efforts)
    ...
    sections =
      [
        ...
        "  allowed_model_efforts: #{yaml_value(codex_allowed_model_efforts)}",
